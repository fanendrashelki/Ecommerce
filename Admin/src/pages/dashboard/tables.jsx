  ...
  <DialogContent dividers>
    <form className="space-y-5 w-full max-w-3xl mx-auto px-2 sm:px-4">
      <div>
        ...
        <Input label="Product Name" name="name" size="lg" />
      </div>
      ...
      <div>
        ...
        <Input label="Image URL" name="image" size="lg" />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <Input label="Brand" name="brand" size="lg" />
        </div>
        <div>
          <Typography variant="h6" color="blue-gray">
            Category
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
          ...
          <Input label="Price" name="price" type="number" size="lg" />
        </div>
        <div>
          <Typography variant="h6" color="blue-gray">
            Old Price
          </Typography>
          <Input label="Old Price" name="oldPrice" type="number" size="lg" />
        </div>
        <div>
          <Typography variant="h6" color="blue-gray">
            Discount (%)
          </Typography>
          <Input label="Discount" name="discount" type="number" size="lg" />
        </div>
      </div>
    </form>
  </DialogContent>
